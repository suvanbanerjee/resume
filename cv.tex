...
%----------Education-----------
  ...
  \section{Education}
    \resumeSubHeadingListStart
      \resumeSubheading
        {Dayananda Sagar College Of Engineering}{SGPA: 9}%
...
%----------Experience-----------
    ...
    \begin{tabularx}{\linewidth}{ @{}l r@{} }
      \vspace{-5pt}
      \textbf{Opensource}|\textit{Open Voice OS} & \hfill \href{https://github.com/suvanbanerjee}{Github} \\
      \multicolumn{1}{@{}X@{}}{
        \begin{itemize}
          \item Contributed to Open Voice OS, an open-source project that aims to provide a open-source voice assistant
          \item Helped in developing the instllation script that installs the voice assistant using bash and ansible.
          \item Created skill and api to interact with the voice assistant to get stock prices.
          \item Worked on the documentation and testing and created landing page for new translators.
